...
from src.shemas.facilities import RoomFacility, RoomFacilityAdd
...
async def update_hotel_part(hotel_id: int, room_id: int, room_data: RoomPatchRequest,db: DBDep):
